...
import { View, Image, Text, StyleSheet, TouchableHighlight, Switch, TouchableWithoutFeedback } from 'react-native'
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            {subtitle && (<Text style={styles.sub} numberOfLines={2}>{subtitle}</Text>)}
             ...
             <MaterialCommunityIcons  name="chevron-right" color={colors.black} size={30}/>
